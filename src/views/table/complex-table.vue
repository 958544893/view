    ...
    <div id="complextable">
        ...
        <div id='idd'>
            <el-form :inline="true" :model="formInline" class="demo-form-inline" style='margin-top:10px;margin-left: 20px'>
                ...
                <el-select v-model="formInline.value2" placeholder="重要性" style='width: 6%'>
                 ...
                 :default-sort = "{prop:'date', order: 'descending'}">
                    ...
                    <el-table-column
                     ...
                     filter-placement="bottom-end">
                        <template slot-scope="scope">
                            <el-tag
                             :type="scope.row.tag == 'published' ? 'success' : (scope.row.tag == 'draft'?'info':'danger')"
            ...
            <el-menu
             ...
             :collapse="isCollapse">
                ...
                <el-submenu index="9">
                    ...
                    <el-menu-item-group>
                        <router-link to='/dynamictable'><el-menu-item index="4-1">动态Table</el-menu-item></router-link>
   ...
   name:"complextable",
    ...
    methods:{
        ...
        handleFormSave() {
            ...
            this.tableData[this.ruleForm.num].url = this.ruleForm.url;
            this.tableData[this.ruleForm.num].tag = this.ruleForm.tag;
            this.tableData[this.ruleForm.num].value = this.ruleForm.value;
            this.tableData[this.ruleForm.num].important = this.ruleForm.important;
            if(this.tableData[this.ruleForm.num].tag ==='draft'){
                console.log(this.tableData[this.ruleForm.num].operate='发布') 
            }else if(this.tableData[this.ruleForm.num].tag ==='published'){
                console.log(this.tableData[this.ruleForm.num].operate='草稿') 
            }else{
                console.log(this.tableData[this.ruleForm.num].operate='发布')
            }
            this.tableData[this.ruleForm.num].time =this.ruleForm.time.getFullYear()+'-'+(this.ruleForm.time.getMonth()+1)+'-'+this.ruleForm.time.getDate()+' '+this.ruleForm.time.getHours()+':'+this.ruleForm.time.getMinutes();
            console.log(num)
        },
        handleEdit(index, rowData) {
            console.log(index, rowData);
            const num=(this.page-1)*this.limit&&index;
        ...
        handleDelete(index,row){
            let num = (this.page - 1) * this.limit + index;
...
.el-input_suffix>>>input.el-input__suffix-inner{
    height:40px;
}
</style>